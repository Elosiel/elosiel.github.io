...
function di_magazine_admin_notice() {
	...
	if( ! get_user_meta( $user_id, 'di_magazine_ignore_notice' ) ) {
		...
		printf( __( 'Thank you for activating Di Magazine Theme. Let start from <a target="_blank" href="%1$s">Video Tutorials</a> | <a target="_blank" href="%2$s">Documentation</a> | <a target="_blank" href="%3$s">Visit Demo</a> | <a target="_blank" href="%4$s">Customize Now</a> | <a href="%5$s">Hide it</a>', 'di-magazine' ), 'https://www.youtube.com/watch?v=hNA_JXmuOw8&list=PLi1mp3OyXn1YWy0L3UW_BguSjJAKywKlg', 'https://dithemes.com/di-magazine-free-wordpress-theme-documentation/', 'http://demo.dithemes.com/di-magazine/', esc_url( get_admin_url() . 'customize.php' ) , esc_url( add_query_arg( 'di_magazine_notics_ignore', '0' ) ) );
