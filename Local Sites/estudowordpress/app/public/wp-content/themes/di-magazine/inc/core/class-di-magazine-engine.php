...
class Di_Magazine_Engine {
	...
	public function scripts_and_styles() {
		...
		if( is_front_page() )  {
			...
			wp_enqueue_script( 'di-magazine-owl-carousel', trailingslashit( get_template_directory_uri() ) . 'assets/js/owl.carousel.dim.js', array( 'jquery', 'owl-carousel' ), DI_MAGAZINE_VERSION, true );
		}
	}
